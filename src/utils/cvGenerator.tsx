      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.headerContainer}>
          ...
          <View style={styles.socialLinks}>
            <Link style={styles.link} src={`https://${data.github}`}>
              GitHub
            </Link>
            <Link style={styles.link} src={`https://${data.linkedin}`}>
              LinkedIn
            </Link>
          </View>
        </View>
        ...
        {/* Skills */}
        <View style={styles.section}>
          <Text style={styles.subHeader}>{language === 'fr' ? 'Compétences' : 'Skills'}</Text>
        ...
        {/* Experience */}
        <View style={styles.section}>
          <Text style={styles.subHeader}>{language === 'fr' ? 'Expériences' : 'Experience'}</Text>
        ...
        {/* Projects */}
        <View style={styles.section}>
          <Text style={styles.subHeader}>{language === 'fr' ? 'Projets' : 'Projects'}</Text>
